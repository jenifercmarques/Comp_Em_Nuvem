...
class Settings(BaseSettings):
    ...
    # `local`    : grava eventos em arquivo JSON local.
    # `dynamodb` : grava eventos em tabela DynamoDB.
    ...
    # Endpoint customizado para DynamoDB Local (opcional em desenvolvimento).
