...
class TaskCreate(TaskBase):
    ...
    created_at: datetime | None = Field(
        default=None,
        description="Timestamp opcional de criação para compatibilidade em cenários de migração.",
    )
    updated_at: datetime | None = Field(
        default=None,
        description="Timestamp opcional de atualização para compatibilidade em cenários de migração.",
    )
